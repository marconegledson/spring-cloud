...
### References
* [Hydrix](https://spring.io/guides/gs/circuit-breaker/)
* [Spring Retry](https://www.baeldung.com/spring-retry)

### Examples Server
* [http://localhost:8080/consumer/hydrix/](http://localhost:8080/consumer/hydrix/)
* [http://localhost:8080/consumer/retry/](http://localhost:8080/consumer/retry/)
